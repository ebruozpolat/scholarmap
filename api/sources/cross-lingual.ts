...
const TR_EN_TERMS: Record<string, string> = {
  ...
  "çapraz dil": "cross-lingual",
  "bilgi erişimi": "information retrieval",
  "öneri sistem": "recommender system",
  ...
  "graf sinir ağ": "graph neural network",
  "federatif öğrenme": "federated learning",
  "açıklanabilir yapay zeka": "explainable artificial intelligence",
  "az örnekle öğrenme": "few-shot learning",
  "sıfır örnekle öğrenme": "zero-shot learning",
  // Medical / bio
  "tümör": "tumor",
